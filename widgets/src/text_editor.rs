...
pub struct TextEditor<'a, Highlighter, Message, Theme = cosmic::Theme, Renderer = cosmic::Renderer>
where
...
pub struct Content<R = cosmic::Renderer>(RefCell<Internal<R>>)
where
    R: text::Renderer;
...
pub trait Catalog: cosmic::iced::theme::Base {
